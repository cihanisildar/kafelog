  ...
  const filteredCafes = cafes.filter((cafe) => {
    ...
    const matchesFilter =
      selectedFilter === "all" ? true :
        selectedFilter === "open" ? cafe.openNow :
          selectedFilter === "nearby" ? parseFloat(cafe.distance) < 2 :
            true;
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-gray-500 text-sm">({cafe.reviews} değerlendirme)</span>
                  </div>
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span className="text-sm">{cafe.address} • {cafe.distance}</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-600">
                      <Coffee className="h-4 w-4" />
                      <span className="text-sm">{cafe.specialty} • {cafe.priceRange}</span>
                    </div>
                  </div>
